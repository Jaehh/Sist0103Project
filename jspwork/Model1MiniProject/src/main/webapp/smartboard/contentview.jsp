  ...
  <!-- 상세페이지 적당히 만들어볼것!
   ...
   <input type="hidden" >
      ...
      <table class="table table-bordered">
         ...
         <div class="aform">
         <input type="text" id="nickname" class="from-control" style="width:100px;"
         placeholder="닉네임">
         <input type="text" id="content" class="from-control" style="width:100px;"
         placeholder="댓글메세지">
         <button type="button" id ="btnsend" class="btn btn-info"></button>
         </div>
         </td>
         </tr>
