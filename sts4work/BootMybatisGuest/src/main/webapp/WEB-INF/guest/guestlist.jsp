...
<script type="text/javascript">
	$(function(){
		...
		$("#photos").change(function(){
			...
			$.ajax({
				url:"upload",
				processData:false, /* 서버전달 데이터는 query String 이라는 형태로 전송, 파일전송의 경우는 이를 하지않아야한다 */
				contentType:false, /* enctype이 원래 기본설정이 application/x.www 이건데 multipart/form-data로 변경하는 것이 false */
				type:'post',
				data:fdata,
				dataType:'json',
				success:function(res){
...
<div style="margin:50px 100px;" id="inputform">
	<h4>원하는 사진들을 등록하세요
	<input type="file" name="photos" multiple="multiple" style="display:none;">
    &nbsp;&nbsp;
	<i class="bi bi-file-earmark-image photo" style="font-size:30px;"></i></h4>
	...
	<form id="frm">
		<table class="table table-bordered" style="width:700px;">
			...
			<tr>
				...
				<button type="button" class="btn btn-danger" style="width:90px; height:90px;"
				...
				<td>
					<c:if test="${a.photo!='no'}">
						...
						<a href="../guestphoto/${imp}">
							<img alt="" src="../guestphoto/${img}" style="width:100px; border: 1px solid green";>
						</a>
					...
					<button type="button" class="btn btn-info-btn-sm" onclick="location.href=''">삭제</button>
					<button>삭제</button>
				</td>
			</tr>
		</table>
