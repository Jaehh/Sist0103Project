...
public class JdbcPstmt_01 {
	...
	public void writeSangpum() {
		...
		String sql ="select * from sale order by num asc";
	...
	//수정...num를 인자로 받아서 데이터가 있으면 true 없으면 false를 반환하는 메소드
	...
	public void updateSangpum() {
		...
		//여기에서 isOneData()를 호출해서 그번호가 존재하는 지 확인
